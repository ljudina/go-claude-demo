...
func NewWebUserHandler(userService *service.UserService, roleService *service.RoleService, navItemService *service.NavItemService, authHandler *handler.AuthHandler) *WebUserHandler {
